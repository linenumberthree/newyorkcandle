...
.search p label { display: -webkit-inline-box; width: 80px; margin: 0 10px; }
.search p strong { display: inline-block; width: 50px; }
.box .col-sm-3 { margin-bottom: 20px; }
.box .col-sm-3 img { border: 1px solid #ddd; }
</style>
</head>
<body>
<div class="header_mj">
	<div class="container mainTop">
		...
		<c:if test="${!signIn}">
	      <li><a href="http://vigdsing.cafe24.com/portfolio/join.view">회원가입</a></li>
	      <li><a href="http://vigdsing.cafe24.com/portfolio/login.view">로그인</a></li>
	    </c:if>
	    <c:if test="${signIn }">
	    	<li><a href="http://vigdsing.cafe24.com/portfolio/mypage.do">마이페이지</a></li>
	    	<li><a href="http://vigdsing.cafe24.com/portfolio/logout.do">로그아웃</a></li>
	    </c:if>
	...
	<div class="container mainHeader">
		<h1 class="logo col-sm-3  text-left">
			<a href="http://vigdsing.cafe24.com/portfolio/main.view" title="홈"><img
		...
		<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">캔들</a>
			<ul class="dropdown-menu">
				<li><a href="http://vigdsing.cafe24.com/portfolio/candles.view">캔들</a></li>
		...
		<c:if test="${signIn }">
			<li><a href="http://vigdsing.cafe24.com/portfolio/mypage.do"><span class="glyphicon glyphicon-user"></span><span  class="lnb_text">MyPage</span></a></li>
		</c:if>
			<li><a href="#"><span class="glyphicon glyphicon-shopping-cart"></span><span  class="lnb_text">Cart</span></a></li>
